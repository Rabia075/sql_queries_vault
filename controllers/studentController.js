...
exports.createStudent = async (req, res) => {
  ...
  try {
    ...
    const result = await pool.query(
      ...
      RETURNING *`,
      [full_name, email, phone, gender, date_of_birth, address, department_id, hashedPassword, user_id]
    );
  ...
  async (req, res) => {
    ...
    try {
      ...
      const result = await pool.query(
        ...
        WHERE student_id = $10
        RETURNING *`,
        [full_name, email, phone, gender, date_of_birth, address, department_id, hashedPassword, user_id, id]
      );
  ...
  try {
    ...
    const result = await pool.query(
      `UPDATE Students SET 
        ...
        WHERE student_id = $10
        RETURNING *`,
      [full_name, email, phone, gender, date_of_birth, address, department_id, hashedPassword, user_id, student_id]
    );
